...
NS_LOG_COMPONENT_DEFINE ("part 2");
...
main (int argc, char *argv[])
{
        ...
        ApplicationContainer apps = onoff.Install (wifiStaNodes);//install onoff application on stanodes and configure start/stop times
        UniformVariable var;
