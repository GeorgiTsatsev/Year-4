...
void Joint::SetId(uint8_t id)
{
    ...
    switch (id % 3){
        // ThC
		case 1:
            mx28.SetCWAngleLimit(id,0x055A); // 1370 // 120 // real angle is -60
            mx28.SetCCWAngleLimit(id,0x870); // 2160  // 190 // real angle is 10 
            break;
		// CTr	
        case 2:
