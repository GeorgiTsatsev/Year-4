...
#define tcPEP (0x1000 - 0xA28)
#define tcAEP (0x1000 - 0x762)
...
void Joint::SetId(uint8_t id)
{
    ...
    switch (id % 3){
		...
		case 1:
            ...
            mx28.SetCCWAngleLimit(id,0x876); // 2166  // 190 // real angle is 10 
            break;
		// CTr	
        case 2:
