...
void Joint::SetId(uint8_t id)
{
    ...
    switch (id % 3){
        // ThC
		case 1:
            mx28.SetCWAngleLimit(id,0x640); // 1600 // 140 // real angle is -40
            mx28.SetCCWAngleLimit(id,0xCE4); // 2600 // 230 // real angle is 50 
            break;
		// CTr	
        case 2:
...
// CTr
Hidden sigmoid18(5,12.26);

Hidden sigmoid19(5,-23.3);
